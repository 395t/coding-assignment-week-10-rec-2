...
def get_args_parser():
    ...
    parser.add_argument('--coco_path',
                        default='/scratch1/08401/ywen/data/object_detection/voc2012',
                        type=str)
...
def main(args):
    ...
    if args.resume:
        ...
        keys_vin = checkpoint['model']
        new_state_dict = {k: v if v.size() == current_model[k].size() else current_model[k]
        ...
        #    # checkpoint and also modify lr scheduler (e.g., decrease lr in advance).
